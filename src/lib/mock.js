...
const shopState = {
  cosmetics: [
    ...
    { key: 'avatar_tiger', type: 'avatar_image', title: 'Тигр', price_coins: 260, stackable: false, owned: false, equipped: false },
    ...
    { key: 'avatar_lion', type: 'avatar_image', title: 'Лев', price_coins: 320, stackable: false, owned: false, equipped: false },
    ...
    { key: 'frame_fire', type: 'avatar_frame', title: 'Огонь', price_coins: 220, stackable: false, owned: false, equipped: false },
    { key: 'frame_ice', type: 'avatar_frame', title: 'Лёд', price_coins: 220, stackable: false, owned: false, equipped: false },
    ...
    { key: 'frame_rainbow', type: 'avatar_frame', title: 'Радуга', price_coins: 320, stackable: false, owned: false, equipped: false },
    { key: 'frame_aurora', type: 'avatar_frame', title: 'Аврора', price_coins: 320, stackable: false, owned: false, equipped: false },
    { key: 'frame_galaxy', type: 'avatar_frame', title: 'Галактика', price_coins: 320, stackable: false, owned: false, equipped: false },
    { key: 'frame_phoenix', type: 'avatar_frame', title: 'Феникс', price_coins: 320, stackable: false, owned: false, equipped: false },
    { key: 'badge_lucky', type: 'badge', title: '🍀 Счастливчик', price_coins: 120, stackable: false, owned: false, equipped: false },
    { key: 'badge_gambler', type: 'badge', title: '🎲 Азартный', price_coins: 120, stackable: false, owned: false, equipped: false },
    ...
    { key: 'badge_sharpshooter', type: 'badge', title: '🎯 Точный расчёт', price_coins: 240, stackable: false, owned: false, equipped: false },
    ...
    { key: 'badge_champion', type: 'badge', title: '🏆 Чемпион', price_coins: 360, stackable: false, owned: false, equipped: false },
    ...
    { key: 'streak_freeze_10', type: 'streak_freeze', title: '🧊 Заморозка ×10', price_coins: 500, stackable: true, quantity: 10, stock: 0 },
  ],
}
const COIN_PACKS = [
